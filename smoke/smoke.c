...
#define ADCCON3_EVID_64rate (0x00<<4)
#define ADCCON3_ECH (0x7<<0)
...
uint16 readSmokeSensitive(void)
{
	uint16 reading;
	...
	ADCCFG  |= 0x80;
	ADCCON3  = ADCCON3_ECH|ADCCON3_EREF|ADCCON3_EVID_64rate;
	ADCCON1 |= 0x40;
