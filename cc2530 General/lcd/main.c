...
void main(void)
{
	...
	BACK_COLOR=WHITE;//初始化背景色
	POINT_COLOR=BLACK;//字体颜色为白色，如果这两种颜色需要换的，可以根据hal_lcd.h里面的相关定义进行更换 
	LCD_Clear(BACK_COLOR); //清屏

	#if 1
	/*显示无线传感网*/
	char offset = 20;
	showhanzi16x16(0 + offset,10,0,wu,POINT_COLOR,BACK_COLOR);
	showhanzi16x16(17+ offset,10,0,xian,POINT_COLOR,BACK_COLOR);
	showhanzi16x16(34+ offset,10,0,chuan,POINT_COLOR,BACK_COLOR);
   
    showhanzi16x16(51+ offset,10,0,gan,POINT_COLOR,BACK_COLOR);
    showhanzi16x16(68+ offset,10,0,wang,POINT_COLOR,BACK_COLOR);
	showimage(40,40,40,40,gImage_qq);
	#endif
